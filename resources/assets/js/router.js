...
//define routes
const routes = [
        { name:'Tableau de bord', path: '/', component: require('./pages/dashboard.vue')},
        // /**
        // **    general routes
        // **/
        { path: '/apropos', component: require('./pages/apropos.vue')},
        { path: '/support', component: require('./pages/support.vue')},

        { path: '/clients', component: require('./pages/clients.vue')},
        { path: '/tickets', component: require('./pages/tickets.vue')},
        { path: '/mailbox', component: require('./pages/mailbox.vue')},
        { path: '/utilisateurs', component: require('./pages/utilisateurs.vue')},
        { path: '/parametres', component: require('./pages/parametres.vue')},
