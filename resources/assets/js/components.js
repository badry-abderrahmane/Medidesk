...
// Menus
Vue.component('menu-list-count', require('./components/menus/menuListCount.vue'));




// Tables
Vue.component('table-data', require('./components/tables/tableData.vue'));
Vue.component('table-data-embed', require('./components/tables/tableDataEmbed.vue'));
...
// Tabs
Vue.component('tab-basic', require('./components/tabs/tabBasic.vue'));
